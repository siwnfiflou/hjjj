...
if [ -z "$HFF_TOKEN" ] || [ -z "$DATASET_ID" ]; then
    log_error "未启用备份功能 - 缺少HFF_TOKEN或DATASET_ID环境变量"
    log_info "HFF_TOKEN=${HFF_TOKEN:0:3}... DATASET_ID=${DATASET_ID}"
    exit 0
fi
...
log_info "HFF_TOKEN: ${HFF_TOKEN:0:5}..."
